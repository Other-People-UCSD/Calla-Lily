...
<div class="center">
  <img src="/public/images/1/boys-night-1-jack-yang.png" alt="Floodwater covers the ground, yet two leaning streetlights illuminate the night. A dark outline of a wall can be seen in the foreground." class="w650" />
</div>
...
<div class="center">
  <img src="{{ site.baseurl }}/uploads/1/boys-night-2-jack-yang.png" alt="A second-floor plaza hallway with indistinguishable objects though the room openings. Moonlight shines through the cieling and illuminates the first-floor through the opening." class="w650" />
</div>
