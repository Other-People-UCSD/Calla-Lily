...
/**
 * Get an excerpt of the works in a specific group by Collection Number or Content year.
 * @param {String} group The type of group
 * @param {String} value The group value to match
 * @param {Object} input The pool of works to filter through
 * @returns 
 */
 ...
 * @param {Array.<Object>} allPostsData All posts already sorted by date 
 * @param {String} headerType Determine if the content should include an excerpt
 * @param {String} previewLen The excerpt length in characters to include. Default: 150 chars 
