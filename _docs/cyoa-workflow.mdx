...
["You Have Created An Imaginary Friend" JSON data](/js/imaginary-friend-theo-erickson.json)
...
<p class="center">
  <img src="/images/docs/cyoa-bubbling-state.png" alt="Diagram showing bubbling coloration of passages up a route leaf." class="w450" />
</p>
...
<p class="center">
  <img src="/images/docs/cyoa-bubbling-state-history.png" alt="Diagram showing bubbling state only through the history and not other valid parents." class="w650" />
</p>
...
<p class="center">
  <img src="/images/docs/imaginary-friend-create-story.png" alt="Screenshot showing the passages a user can create a story." class="w650" />
</p>
